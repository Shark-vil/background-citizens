...
return {
	...
	['bgn.settings.spawn.bgn_spawn_block_radius.description'] = 'Описание: запрещает спавн NPC в заданном радиусе. 0 - отключить проверку',
	...
	['bgn.settings.spawn.bgn_runtime_generator_grid_offset.description'] = 'Описание: устанавливает дистанцию между точками в режиме "Grid" генератора. Чем выше значение - тем больше расстояние между точками.',
}