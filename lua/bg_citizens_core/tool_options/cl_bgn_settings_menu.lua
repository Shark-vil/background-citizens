...
hook.Add('PopulateToolMenu', 'BGN_TOOL_CreateSettingsMenu', function()
	spawnmenu.AddToolMenuOption('Options', 'Background NPCs', 'BGN_General_Settings', '#BGN General Settings', '', '', GeneralSettingsMenu)

	spawnmenu.AddToolMenuOption('Options', 'Background NPCs', 'BGN_Spawn_Settings', '#BGN Spawn Settings', '', '', SpawnSettingsMenu)

	spawnmenu.AddToolMenuOption('Options', 'Background NPCs', 'BGN_States_Settings', '#BGN States Settings', '', '', StatesSettingsMenu)

	spawnmenu.AddToolMenuOption('Options', 'Background NPCs', 'BGN_Active_NPC_Groups', '#BGN Active NPC Groups', '', '', ActiveNPCsMenu)

	spawnmenu.AddToolMenuOption('Options', 'Background NPCs', 'BGN_Workshop_Services', '#BGN Workshop Services', '', '', WorkshopServicesMenu)
end)