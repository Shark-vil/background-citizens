...
CreateConVar('bg_citizens_spawn_radius_ray_tracing', 1000, FCVAR_ARCHIVE, 'Checks the spawn points of NPCs using ray tracing in a given radius. This parameter must not be more than - bg_citizens_spawn_radius_visibility')